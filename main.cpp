        ...
        for(int xi=x_dolni;xi<x_horni;++xi)
        {
            for(int yi=y_dolni;yi<y_horni;++yi)
            {
                if(pocetni_matice[yi][xi]==1)
                {
                    if(xi < hrany.cols)
                    {
                        if(hrany.at<Vec3b>(Point(xi+1,yi)).val[0]<30 && hrany.at<Vec3b>(Point(xi+1,yi)).val[1]<30 && hrany.at<Vec3b>(Point(xi+1,yi)).val[2]<30)
                        {
                    ...
                    if(yi < hrany.rows)
                    {
                        if(hrany.at<Vec3b>(Point(xi,yi+1)).val[0]<30 && hrany.at<Vec3b>(Point(xi,yi+1)).val[1]<30 && hrany.at<Vec3b>(Point(xi,yi+1)).val[2]<30)
                        {
